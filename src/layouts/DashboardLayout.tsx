            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 bg-sky-50 border border-sky-200 rounded-lg text-xs font-medium text-sky-800 hover:bg-sky-100 transition shadow-2xs"
                >
                    ...
                    {Object.entries(DEMO_USERS).map(([roleKey, demo]) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 hover:bg-slate-50 transition flex items-center justify-between ${
                          role === roleKey ? 'bg-sky-50/70 font-semibold text-sky-900' : 'text-slate-700'
                        }`}
                      >
